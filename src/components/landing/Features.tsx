...
const features = [
  ...
  { icon: Palette, title: "Multi-Style Art", desc: "Shoujo, shounen, seinen, habesha-fusion — pick a style that fits your tale." },
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6">
        <div className="max-w-2xl mb-16">
          ...
          <p className="mt-4 text-muted-foreground text-lg">
            Everything you need to script, direct and publish a manga.
          </p>
        </div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {features.map((f, i) => (
            <motion.div
              ...
              className="glass-panel rounded-2xl p-6 hover:shadow-soft transition group relative overflow-hidden"
            >
              <div className="absolute -top-12 -right-12 w-32 h-32 bg-primary/8 rounded-full blur-2xl group-hover:bg-primary/15 transition" />
